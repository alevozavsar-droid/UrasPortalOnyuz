...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor119Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor119Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor119Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.IadeDurumlari = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor119Controller.UdfValidValue>(12);
ViewBag.AktarTipleri = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor119Controller.UdfValidValue>(12);
ViewBag.CheckTransactionTypes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor119Controller.UdfValidValue>(12);
...
return View("Index");
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor119Controller.AccountBPModel>(12));
}
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor119Controller.AvailableCheckModel>(12));
}

        [HttpGet("GetDepositNavigation")]
        public IActionResult GetDepositNavigation(int currentDocEntry, string direction)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor119Controller.DepositDetailViewModel>() });
}

        [HttpPost("FindDeposit")]
        public IActionResult FindDeposit([FromBody] DepositSearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor119Controller.DepositSearchResultModel>(12) });
}
 ...
 {return Json(new { success = true, message = "İbraz başarıyla iptal edildi ve çekler portföye geri alındı." });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Satirlar(12, new[] { "DeposId", "DeposNum", "DeposDate", "LocTotal", "DeposType", "BanckAcct", "BanckAcctName", "TahsilatTarihi", "CekNumaralari" }) });
}
 ...
 {return default;
        ...
        {
            public string Currency { get; set; }   // OCHH.Currency (ekranda tutarin yaninda gosterilir)
            public int CheckKey { get; set; }
        ...
        {
            public string DocCurr { get; set; }    // ODPS.DeposCurr: ibraz para birimi
            public decimal FcTotal { get; set; }   // dovizli ibrazda doviz toplami
            public string YerelPb { get; set; }    // sirket yerel para birimi (OADM.MainCurncy)
            public int DeposId { get; set; }
            public int DeposNum { get; set; }
            public string DeposType { get; set; }
            public string ChkType { get; set; } // C = Nakit çek, S = Vadeli çek
            public string DeposDate { get; set; }
            public string BanckAcct { get; set; }
            public string BanckAcctName { get; set; }
        ...
        public class DepositCreationModel
        {
            ...
            public string CheckDepositType { get; set; } // "Cash" (nakit çek) | "PostDated" (vadeli çek)
