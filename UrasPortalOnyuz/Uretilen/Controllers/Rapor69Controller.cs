...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor69Controller : Controller
    {
 ...
 {return default;
        ...
        private bool IsModuleActive(string dbKey)
 {return default;
}

        private List<DosyaSecenek69> GetDosyaListesi(string connectionString)
 {return default;
}
...
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<WebApplication3.Models.Rapor69ViewModel>());
}


        private List<Rapor69Item> GetRaporItems(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
