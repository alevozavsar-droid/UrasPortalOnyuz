...
namespace WebApplication3.Controllers
{
    ...
    [Authorize] // "A" ve "F" yetkilerine sahip kullanıcılar erişebilir. (Policy name kept as per original request)
    [Route("[controller]")] // Bu route attribute'u Rapor7Controller'ı /Rapor7 olarak eşler.
    public class Rapor7Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor7Controller> _logger;
 ...
 {return default;
        ...
        [Authorize] // Politika adını güncelledik
        public IActionResult Index()
 {ViewBag.SelectedDatabaseKey = "";
ViewBag.CurrentDbDisplay = "";
ViewBag.StokAdiList = new System.Collections.Generic.List<object>();
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.StockMovementAnalysisViewModel>(12));
}
    }
}