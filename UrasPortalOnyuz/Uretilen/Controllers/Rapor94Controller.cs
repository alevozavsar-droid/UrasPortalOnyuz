...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor94Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor94Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Customers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.CustomerModel>(12);
ViewBag.Items = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.ItemModel>(12);
ViewBag.SalesEmployees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.SalesEmployeeModel>(12);
ViewBag.VatGroups = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.VatGroupModel>(12);
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.MuafCodes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.MuafCodeModel>(12);
ViewBag.Countries = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.CountryModel>(12);
ViewBag.States = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.StateModel>(12);
ViewBag.Warehouses = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.WarehouseModel>(12);
ViewBag.Drivers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.DriverModel>(12);
ViewBag.NakliyeFirmalari = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor94Controller.NakliyeFirmaModel>(12);
ViewBag.IhracatIncoterms = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Services.IhracatBilgileri.KodAd>(12);
ViewBag.IhracatKapCinsleri = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Services.IhracatBilgileri.KodAd>(12);
ViewBag.IhracatTasima = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Services.IhracatBilgileri.KodAd>(12);
ViewBag.IhracatOdemeSekli = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Services.IhracatBilgileri.KodAd>(12);
ViewBag.IhracatOdemeKanali = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Services.IhracatBilgileri.KodAd>(12);
ViewBag.IhracatAlanMesajlari = WebApplication3.OrnekDoldurucu.Liste<string>(12);
...
return View("Index");
 ...
 {return Json(new { currency = global::WebApplication3.OrnekDoldurucu.Deger<string>("currency", 0), slpCode = global::WebApplication3.OrnekDoldurucu.Deger<int>("slpCode", 0), extraDays = global::WebApplication3.OrnekDoldurucu.Deger<int>("extraDays", 0), extraMonth = global::WebApplication3.OrnekDoldurucu.Deger<int>("extraMonth", 0), yurtDisi = global::WebApplication3.OrnekDoldurucu.Deger<bool>("yurtDisi", 0), ulke = global::WebApplication3.OrnekDoldurucu.Deger<string>("ulke", 0) });
}


        [HttpGet("IhracatDosyalari")]
        public IActionResult IhracatDosyalari(string cardCode)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Services.IhracatBilgileri.IhracatDosyasi>(12) });
}

        [HttpGet("GetCustomerAddresses")]
        public IActionResult GetCustomerAddresses(string cardCode)
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor94Controller.BPAddressModel>(12));
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor94Controller.OrderDetailViewModel>() });
}

        [HttpPost("FindOrder")]
        public IActionResult FindOrder([FromBody] OrderSearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor94Controller.OrderSearchResultModel>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor94Controller.DriverModel>() });
}
 ...
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0), docEntry = global::WebApplication3.OrnekDoldurucu.Deger<int>("docEntry", 0), deliveryDocNum = global::WebApplication3.OrnekDoldurucu.Deger<int>("deliveryDocNum", 0), invoiceDocNum = global::WebApplication3.OrnekDoldurucu.Deger<int>("invoiceDocNum", 0), faturaTaslak = global::WebApplication3.OrnekDoldurucu.Deger<bool>("faturaTaslak", 0), akis = global::WebApplication3.OrnekDoldurucu.Deger<string>("akis", 0), autoPrint = global::WebApplication3.OrnekDoldurucu.Deger<bool>("autoPrint", 0) });
}
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor94Controller.NakliyeFirmaModel>(12));
}
 ...
 {return Json(new { success = true, message = "Nakliyeci firma eklendi.", firma = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor94Controller.NakliyeFirmaModel>() });
}
 ...
 {return default;
        ...
        public class OrderDetailViewModel
        {
            ...
            public IhracatBilgileriModel Ihracat { get; set; }
