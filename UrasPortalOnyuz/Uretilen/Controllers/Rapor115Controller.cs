...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor115Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor115Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Customers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.CustomerModel>(12);
ViewBag.Items = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.ItemModel>(12);
ViewBag.SalesEmployees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.SalesEmployeeModel>(12);
ViewBag.VatGroups = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.VatGroupModel>(12);
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.MuafCodes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.MuafCodeModel>(12);
ViewBag.Countries = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.CountryModel>(12);
ViewBag.States = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.StateModel>(12);
ViewBag.Warehouses = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.WarehouseModel>(12);
ViewBag.Drivers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor115Controller.DriverModel>(12);
...
return View("Index");
        ...
        private static readonly int[] _izinliBazTipleri = new int[] { 20 };
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor115Controller.PurchaseReturnDetailViewModel>(), baseTypeName = global::WebApplication3.OrnekDoldurucu.Deger<string>("baseTypeName", 0), baseType = global::WebApplication3.OrnekDoldurucu.Deger<int>("baseType", 0), baseEntry = global::WebApplication3.OrnekDoldurucu.Deger<int>("baseEntry", 0) });
}
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor115Controller.BPAddressModel>(12));
}
 ...
 {return Json(new { onHand = 0 });
        ...
        [HttpGet("GetPurchaseReturnNavigation")]
        public IActionResult GetPurchaseReturnNavigation(int currentDocEntry, string direction)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor115Controller.PurchaseReturnDetailViewModel>() });
}

        [HttpPost("FindPurchaseReturn")]
        public IActionResult FindPurchaseReturn([FromBody] PurchaseReturnSearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor115Controller.PurchaseReturnSearchResultModel>(12) });
}

        [HttpGet("GetPurchaseReturnDetails")]
        public IActionResult GetPurchaseReturnDetails(int docEntry)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor115Controller.PurchaseReturnDetailViewModel>() });
}

        [HttpPost("AddDriver")]
        public IActionResult AddDriver([FromBody] DriverModel request)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor115Controller.DriverModel>() });
}
        ...
        public async Task<IActionResult> CreatePurchaseReturn([FromBody] PurchaseReturnCreationModel request)
 ...
 {return default;
        ...
        public class PurchaseReturnSearchResultModel
        {
        ...
        public class PurchaseReturnDetailViewModel
        {
            ...
            public List<PurchaseReturnLineModel> Lines { get; set; } = new List<PurchaseReturnLineModel>();
        }

        public class PurchaseReturnCreationModel
        {
            public string CardCode { get; set; }
            ...
            public AddressExtensionModel AddressExtension { get; set; }
            public List<PurchaseReturnLineModel> DocumentLines { get; set; }
        }

        public class PurchaseReturnLineModel
        {
