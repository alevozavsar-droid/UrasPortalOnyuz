...
using WebApplication3.Models; // DatabaseConfig sınıfınızın olduğu yer

namespace WebApplication3.Controllers
{
    [Route("[controller]")]
    public class Rapor56Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor56Controller> _logger;
...
return View("Index");
 ...
 {return Json(new { data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor56Controller.ZeroItemViewModel>(12), totalRecords = global::WebApplication3.OrnekDoldurucu.Deger<int>("totalRecords", 0) });
}

        private async Task<List<ZeroItemViewModel>> GetDataFromDatabase(string connectionString, string dbName)
 {return default;
}


        public class ZeroItemViewModel
        {
            ...
            public DateTime BelgeTarihiRaw { get; set; }
            ...
            public decimal TahminiToplamDeger { get; set; }
