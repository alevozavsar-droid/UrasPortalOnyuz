...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor66Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor66ViewModel>(12));
}

        private List<Rapor66ViewModel> GetRaporData(string connectionString, DateTime startDate, DateTime endDate, List<string> selectedCaris, List<string> selectedItems)
 {return default;
}
