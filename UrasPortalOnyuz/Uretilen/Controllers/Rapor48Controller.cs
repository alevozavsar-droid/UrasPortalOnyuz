...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor48Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.IadeEdilenMalzemeViewModel>(12));
}
        ...
        private List<IadeEdilenMalzemeViewModel> GetIadeEdilenMalzemeData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
