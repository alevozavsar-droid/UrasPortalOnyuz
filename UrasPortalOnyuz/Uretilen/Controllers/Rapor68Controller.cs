...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor68Controller : Controller
    {
 ...
 {return default;
        ...
        private int GetGroupCodeForCompany(string dbKey)
 {return default;
}

        private List<DosyaSecenek> GetDosyaListesi(string connectionString)
 {return default;
}
...
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<WebApplication3.Models.Rapor68ViewModel>());
}

        private List<Rapor68Item> GetRaporItems(string connectionString, DateTime startDate, DateTime endDate, int groupCode)
 {return default;
}

        [HttpPost("UpdateDosyaNo")]
        public IActionResult UpdateDosyaNo(int transId, string dosyaNo)
