...
namespace WebApplication3.Controllers
{
    ...
    public class Rapor156Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor156Controller> _logger;
        ...
        private static readonly string HedefCompanyDb = "ALVFILO_2026";

        [HttpGet]
        [HttpGet("Index")]
        public async Task<IActionResult> Index(string activeTab = "sayim", int? yil = null, int? ay = null)
 {WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<WebApplication3.Controllers.Rapor156ViewModel>());
}
 ...
 {return Json(new { success = true, summary = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.R156_AktarimOzet>(), sayim = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.R156_YevmiyeSayim>() });
}

        [HttpGet("GetKuyrukData")]
        public async Task<IActionResult> GetKuyrukData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_AktarimDetay>(12) });
}

        [HttpGet("GetKimliksizData")]
        public async Task<IActionResult> GetKimliksizData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_KimliksizYevmiye>(12) });
}

        [HttpGet("GetManuelData")]
        public async Task<IActionResult> GetManuelData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_ManuelYevmiye>(12) });
}

        [HttpGet("GetMukerrerData")]
        public async Task<IActionResult> GetMukerrerData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_MukerrerYevmiye>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_IsaretDegismisYevmiye>(12) });
}

        [HttpGet("GetKapaliDonemData")]
        public async Task<IActionResult> GetKapaliDonemData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_KapaliDonemYevmiye>(12) });
}

        [HttpGet("GetEksikData")]
        public async Task<IActionResult> GetEksikData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_EksikYevmiye>(12) });
}

        [HttpGet("GetIptalData")]
        public async Task<IActionResult> GetIptalData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_YevmiyeIptalFark>(12) });
}

        [HttpGet("GetStokData")]
        public async Task<IActionResult> GetStokData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_StokHareketRaporu>(12) });
}

        [HttpGet("GetYoksayilanData")]
        public async Task<IActionResult> GetYoksayilanData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_YoksayilanYevmiye>(12) });
}

        [HttpGet("GetFazlaData")]
        public async Task<IActionResult> GetFazlaData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_FazlaYevmiye>(12) });
}

        [HttpGet("GetManuelAnalizData")]
        public async Task<IActionResult> GetManuelAnalizData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_ManuelIslemDurumu>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_FiyatFark>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_AlisSatis>(12) });
}

        [HttpGet("GetStokAkisData")]
        public async Task<IActionResult> GetStokAkisData(int? yil, int? ay)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_StokAkis>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R156_StokBelgeKontrolItem>(12) });
}
 ...
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
    ...
    public class Rapor156ViewModel
    {
        public R156_AktarimOzet Summary { get; set; }
        public R156_YevmiyeSayim Sayim { get; set; }
        public List<R156_AktarimDetay> KuyrukListesi { get; set; }
        public List<R156_MukerrerYevmiye> MukerrerKayitlar { get; set; }
        public List<R156_EksikYevmiye> EksikKayitlar { get; set; }
        public List<R156_KimliksizYevmiye> KimliksizKayitlar { get; set; }
        public List<R156_ManuelYevmiye> ManuelKayitlar { get; set; }
        public List<R156_YevmiyeIptalFark> IptalFarkliKayitlar { get; set; }
        public List<R156_StokHareketRaporu> StokHareketleri { get; set; }
        public List<R156_YoksayilanYevmiye> YoksayilanKayitlar { get; set; }
        public List<R156_FazlaYevmiye> FazlaKayitlar { get; set; }
        public List<R156_ManuelIslemDurumu> ManuelIslemDurumlari { get; set; }
        public List<R156_EksikHataliStokHareketi> EksikHataliStokHareketleri { get; set; } = new List<R156_EksikHataliStokHareketi>();
        public List<R156_StokBelgeKontrolItem> StokBelgeKontrolListesi { get; set; } = new List<R156_StokBelgeKontrolItem>();
    }

    public class R156_StokBelgeKontrolItem
    {
    ...
    public class R156_YevmiyeSayim
    {
    ...
    public class R156_IsaretDegismisYevmiye
    {
    ...
    public class R156_KapaliDonemYevmiye
    {
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
        public string BelgeTipi { get; set; }
    ...
    public class R156_KimliksizYevmiye
    {
    ...
    public class R156_ManuelYevmiye
    {
        public int HedefYevmiyeNo { get; set; }
        public string OlusanBelgeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R156_MukerrerYevmiye
    {
        public int HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string OlusanBelgeNo { get; set; }
    ...
    public class R156_EksikYevmiye
    {
    ...
    public class R156_YevmiyeIptalFark
    {
        public string Kategori { get; set; }          // Yevmiye | Stok Belgesi
        public string Neden { get; set; }
        public string KaynakYevmiyeNo { get; set; }
    ...
    public class R156_AktarimDetay
    {
    ...
    public class R156_StokHareketRaporu
    {
        public int KuyrukNo { get; set; }
    ...
    public class R156_YoksayilanYevmiye
    {
        public string KaynakYevmiyeNo { get; set; }
    ...
    public class R156_FazlaYevmiye
    {
        public string HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R156_ManuelIslemDurumu
    {
        public string HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R156_EksikHataliStokHareketi
    {
        public string KaynakBelgeTipi { get; set; }
        public string KaynakBelgeNo { get; set; }
        public string KaynakTarih { get; set; }
