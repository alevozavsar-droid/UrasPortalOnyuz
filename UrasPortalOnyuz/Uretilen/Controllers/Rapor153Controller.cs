...
namespace WebApplication3.Controllers
{
    ...
    public class Rapor153Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor153Controller> _logger;
        ...
        private static readonly string HedefCompanyDb = "DAFKIMYA_2026";

        [HttpGet]
        [HttpGet("Index")]
        public async Task<IActionResult> Index(string activeTab = "sayim", int? yil = null, int? ay = null)
 {WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<WebApplication3.Controllers.Rapor153ViewModel>());
}
 ...
 {return Json(new { success = true, summary = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.R153_AktarimOzet>(), sayim = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.R153_YevmiyeSayim>() });
}

        [HttpGet("GetKuyrukData")]
        public async Task<IActionResult> GetKuyrukData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_AktarimDetay>(12) });
}

        [HttpGet("GetKimliksizData")]
        public async Task<IActionResult> GetKimliksizData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_KimliksizYevmiye>(12) });
}

        [HttpGet("GetManuelData")]
        public async Task<IActionResult> GetManuelData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_ManuelYevmiye>(12) });
}

        [HttpGet("GetMukerrerData")]
        public async Task<IActionResult> GetMukerrerData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_MukerrerYevmiye>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_IsaretDegismisYevmiye>(12) });
}

        [HttpGet("GetKapaliDonemData")]
        public async Task<IActionResult> GetKapaliDonemData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_KapaliDonemYevmiye>(12) });
}

        [HttpGet("GetEksikData")]
        public async Task<IActionResult> GetEksikData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_EksikYevmiye>(12) });
}

        [HttpGet("GetIptalData")]
        public async Task<IActionResult> GetIptalData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_YevmiyeIptalFark>(12) });
}

        [HttpGet("GetStokData")]
        public async Task<IActionResult> GetStokData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_StokHareketRaporu>(12) });
}

        [HttpGet("GetYoksayilanData")]
        public async Task<IActionResult> GetYoksayilanData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_YoksayilanYevmiye>(12) });
}

        [HttpGet("GetFazlaData")]
        public async Task<IActionResult> GetFazlaData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_FazlaYevmiye>(12) });
}

        [HttpGet("GetManuelAnalizData")]
        public async Task<IActionResult> GetManuelAnalizData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_ManuelIslemDurumu>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_FiyatFark>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_AlisSatis>(12) });
}

        [HttpGet("GetStokAkisData")]
        public async Task<IActionResult> GetStokAkisData(int? yil, int? ay)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_StokAkis>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R153_StokBelgeKontrolItem>(12) });
}
 ...
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
    ...
    public class Rapor153ViewModel
    {
        public R153_AktarimOzet Summary { get; set; }
        public R153_YevmiyeSayim Sayim { get; set; }
        public List<R153_AktarimDetay> KuyrukListesi { get; set; }
        public List<R153_MukerrerYevmiye> MukerrerKayitlar { get; set; }
        public List<R153_EksikYevmiye> EksikKayitlar { get; set; }
        public List<R153_KimliksizYevmiye> KimliksizKayitlar { get; set; }
        public List<R153_ManuelYevmiye> ManuelKayitlar { get; set; }
        public List<R153_YevmiyeIptalFark> IptalFarkliKayitlar { get; set; }
        public List<R153_StokHareketRaporu> StokHareketleri { get; set; }
        public List<R153_YoksayilanYevmiye> YoksayilanKayitlar { get; set; }
        public List<R153_FazlaYevmiye> FazlaKayitlar { get; set; }
        public List<R153_ManuelIslemDurumu> ManuelIslemDurumlari { get; set; }
        public List<R153_EksikHataliStokHareketi> EksikHataliStokHareketleri { get; set; } = new List<R153_EksikHataliStokHareketi>();
        public List<R153_StokBelgeKontrolItem> StokBelgeKontrolListesi { get; set; } = new List<R153_StokBelgeKontrolItem>();
    }

    public class R153_StokBelgeKontrolItem
    {
    ...
    public class R153_YevmiyeSayim
    {
    ...
    public class R153_IsaretDegismisYevmiye
    {
    ...
    public class R153_KapaliDonemYevmiye
    {
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
        public string BelgeTipi { get; set; }
    ...
    public class R153_KimliksizYevmiye
    {
    ...
    public class R153_ManuelYevmiye
    {
        public int HedefYevmiyeNo { get; set; }
        public string OlusanBelgeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R153_MukerrerYevmiye
    {
        public int HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string OlusanBelgeNo { get; set; }
    ...
    public class R153_EksikYevmiye
    {
    ...
    public class R153_YevmiyeIptalFark
    {
        public string Kategori { get; set; }          // Yevmiye | Stok Belgesi
        public string Neden { get; set; }
        public string KaynakYevmiyeNo { get; set; }
    ...
    public class R153_AktarimDetay
    {
    ...
    public class R153_StokHareketRaporu
    {
        public int KuyrukNo { get; set; }
    ...
    public class R153_YoksayilanYevmiye
    {
        public string KaynakYevmiyeNo { get; set; }
    ...
    public class R153_FazlaYevmiye
    {
        public string HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R153_ManuelIslemDurumu
    {
        public string HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R153_EksikHataliStokHareketi
    {
        public string KaynakBelgeTipi { get; set; }
        public string KaynakBelgeNo { get; set; }
        public string KaynakTarih { get; set; }
