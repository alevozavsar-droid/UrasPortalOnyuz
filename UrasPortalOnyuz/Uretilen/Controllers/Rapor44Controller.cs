...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor44Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.AylikGiderRaporuViewModel>(12));
}
        ...
        private List<AylikGiderRaporuViewModel> GetAylikRaporData(string connectionString, int year)
 {return default;
}
