...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor99Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor99Controller> _logger;
        ...
        private static readonly string HedefCompanyDb = "ASIAKIMYA_AS";

        [HttpGet]
        [HttpGet("Index")]
        public async Task<IActionResult> Index(string activeTab = "sayim", int? yil = null, int? ay = null)
 {WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<WebApplication3.Controllers.Rapor99ViewModel>());
}
 ...
 {return Json(new { success = true, summary = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.R99_AktarimOzet>(), sayim = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.R99_YevmiyeSayim>() });
}

        [HttpGet("GetKuyrukData")]
        public async Task<IActionResult> GetKuyrukData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_AktarimDetay>(12) });
}

        [HttpGet("GetKimliksizData")]
        public async Task<IActionResult> GetKimliksizData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_KimliksizYevmiye>(12) });
}

        [HttpGet("GetManuelData")]
        public async Task<IActionResult> GetManuelData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_ManuelYevmiye>(12) });
}

        [HttpGet("GetMukerrerData")]
        public async Task<IActionResult> GetMukerrerData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_MukerrerYevmiye>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_IsaretDegismisYevmiye>(12) });
}

        [HttpGet("GetKapaliDonemData")]
        public async Task<IActionResult> GetKapaliDonemData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_KapaliDonemYevmiye>(12) });
}

        [HttpGet("GetEksikData")]
        public async Task<IActionResult> GetEksikData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_EksikYevmiye>(12) });
}

        [HttpGet("GetIptalData")]
        public async Task<IActionResult> GetIptalData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_YevmiyeIptalFark>(12) });
}

        [HttpGet("GetStokData")]
        public async Task<IActionResult> GetStokData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_StokHareketRaporu>(12) });
}

        [HttpGet("GetYoksayilanData")]
        public async Task<IActionResult> GetYoksayilanData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_YoksayilanYevmiye>(12) });
}

        [HttpGet("GetFazlaData")]
        public async Task<IActionResult> GetFazlaData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_FazlaYevmiye>(12) });
}

        [HttpGet("GetManuelAnalizData")]
        public async Task<IActionResult> GetManuelAnalizData()
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_ManuelIslemDurumu>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_FiyatFark>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_AlisSatis>(12) });
}

        [HttpGet("GetStokAkisData")]
        public async Task<IActionResult> GetStokAkisData(int? yil, int? ay)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_StokAkis>(12) });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.R99_StokBelgeKontrolItem>(12) });
}
 ...
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
    ...
    public class Rapor99ViewModel
    {
        public R99_AktarimOzet Summary { get; set; }
        public R99_YevmiyeSayim Sayim { get; set; }
        public List<R99_AktarimDetay> KuyrukListesi { get; set; }
        public List<R99_MukerrerYevmiye> MukerrerKayitlar { get; set; }
        public List<R99_EksikYevmiye> EksikKayitlar { get; set; }
        public List<R99_KimliksizYevmiye> KimliksizKayitlar { get; set; }
        public List<R99_ManuelYevmiye> ManuelKayitlar { get; set; }
        public List<R99_YevmiyeIptalFark> IptalFarkliKayitlar { get; set; }
        public List<R99_StokHareketRaporu> StokHareketleri { get; set; }
        public List<R99_YoksayilanYevmiye> YoksayilanKayitlar { get; set; }
        public List<R99_FazlaYevmiye> FazlaKayitlar { get; set; }
        public List<R99_ManuelIslemDurumu> ManuelIslemDurumlari { get; set; }
        public List<R99_EksikHataliStokHareketi> EksikHataliStokHareketleri { get; set; } = new List<R99_EksikHataliStokHareketi>();
        public List<R99_StokBelgeKontrolItem> StokBelgeKontrolListesi { get; set; } = new List<R99_StokBelgeKontrolItem>();
    }

    public class R99_StokBelgeKontrolItem
    {
    ...
    public class R99_IsaretDegismisYevmiye
    {
    ...
    public class R99_KapaliDonemYevmiye
    {
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
        public string BelgeTipi { get; set; }
    ...
    public class R99_KimliksizYevmiye
    {
    ...
    public class R99_ManuelYevmiye
    {
        public int HedefYevmiyeNo { get; set; }
        public string OlusanBelgeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R99_MukerrerYevmiye
    {
        public int HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string OlusanBelgeNo { get; set; }
    ...
    public class R99_YevmiyeIptalFark
    {
        public string Kategori { get; set; }          // Yevmiye | Stok Belgesi
        public string Neden { get; set; }
        public string KaynakYevmiyeNo { get; set; }
    ...
    public class R99_StokHareketRaporu
    {
        public int KuyrukNo { get; set; }
    ...
    public class R99_YoksayilanYevmiye
    {
        public string KaynakYevmiyeNo { get; set; }
    ...
    public class R99_ManuelIslemDurumu
    {
        public string HedefYevmiyeNo { get; set; }
        public string KaynakYevmiyeNo { get; set; }
        public string Tarih { get; set; }
    ...
    public class R99_EksikHataliStokHareketi
    {
        public string KaynakBelgeTipi { get; set; }
        public string KaynakBelgeNo { get; set; }
        public string KaynakTarih { get; set; }
