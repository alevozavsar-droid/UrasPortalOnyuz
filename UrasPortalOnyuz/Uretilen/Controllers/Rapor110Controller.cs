...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor110Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor110Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Customers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.CustomerModel>(12);
ViewBag.Items = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.ItemModel>(12);
ViewBag.SalesEmployees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.SalesEmployeeModel>(12);
ViewBag.VatGroups = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.VatGroupModel>(12);
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.MuafCodes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.MuafCodeModel>(12);
ViewBag.Countries = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.CountryModel>(12);
ViewBag.States = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.StateModel>(12);
ViewBag.Warehouses = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.WarehouseModel>(12);
ViewBag.Drivers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor110Controller.DriverModel>(12);
...
return View("Index");
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor110Controller.BPAddressModel>(12));
}
 ...
 {return Json(new { onHand = 0 });
        ...
        [HttpGet("GetReturnNavigation")]
        public IActionResult GetReturnNavigation(int currentDocEntry, string direction)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor110Controller.ReturnDetailViewModel>() });
}

        [HttpPost("FindReturn")]
        public IActionResult FindReturn([FromBody] ReturnSearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor110Controller.ReturnSearchResultModel>(12) });
}

        [HttpGet("GetReturnDetails")]
        public IActionResult GetReturnDetails(int docEntry)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor110Controller.ReturnDetailViewModel>() });
}

        [HttpPost("AddDriver")]
        public IActionResult AddDriver([FromBody] DriverModel request)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor110Controller.DriverModel>() });
}
        ...
        public async Task<IActionResult> CreateReturn([FromBody] ReturnCreationModel request)
 ...
 {return default;
        ...
        public class ReturnSearchResultModel
        {
        ...
        public class ReturnDetailViewModel
        {
            ...
            public List<ReturnLineModel> Lines { get; set; } = new List<ReturnLineModel>();
        }
        ...
        public class ReturnCreationModel
        {
            ...
            public AddressExtensionModel AddressExtension { get; set; }
            public List<ReturnLineModel> DocumentLines { get; set; }
        }
