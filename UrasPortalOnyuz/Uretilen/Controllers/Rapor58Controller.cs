...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor58Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.Rapor58ViewModel>(12));
}

     

        private List<Rapor58ViewModel> GetSatisRaporuData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
