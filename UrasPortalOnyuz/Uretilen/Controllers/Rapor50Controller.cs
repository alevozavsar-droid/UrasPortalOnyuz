...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor50Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.KdvOzetRaporuViewModel>(12));
}
        ...
        private List<KdvOzetRaporuViewModel> GetKdvOzetRaporuData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
