...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor46Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.HesapKategorizasyonViewModel>(12));
}
        ...
        private List<HesapKategorizasyonViewModel> GetHesapKategorizasyonData(string connectionString)
 {return default;
}
