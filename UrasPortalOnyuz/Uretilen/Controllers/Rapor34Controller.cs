...
using System.Data;
using WebApplication3.Models; // CustomerRiskReportViewModel, DatabaseConfig, AccountBalanceViewModel burada tanımlı olmalı

namespace WebApplication3.Controllers
{
    [Route("[controller]")]
    public class Rapor34Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor34Controller> _logger;
 ...
 {return default;
        ...
        private async Task<decimal> GetTotal420BalanceByBpName(string connectionString, string bpName)
 {return default;
}

        public async Task<IActionResult> Index(int monthFilter = 3)
