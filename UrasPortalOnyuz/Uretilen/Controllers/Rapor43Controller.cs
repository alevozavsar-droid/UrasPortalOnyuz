...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor43Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.MuhasebeSatisRaporuViewModel>(12));
}
        ...
        private List<MuhasebeSatisRaporuViewModel> GetSatisRaporuData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
