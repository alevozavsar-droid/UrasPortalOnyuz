...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor104Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<System.Data.DataTable>());
}

        private DataTable GetReportData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
