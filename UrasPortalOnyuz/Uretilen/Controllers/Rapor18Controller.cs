...
using static WebApplication3.Controllers.Rapor32Controller;

namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor18Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor18Controller> _logger;
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.OrderTrackingViewModel>(12));
}



        [HttpGet("ProformaFatura/{docNum}")]
        public async Task<IActionResult> ProformaFatura(int docNum)
 {return Content("Ön yüz örneği: dosya üretilmez.", "text/plain; charset=utf-8");
}



        [HttpGet("GetPackingListTemplate/{ihracatDosyaNo}/{faturaNo}")]
        public async Task<IActionResult> GetPackingListTemplate(string ihracatDosyaNo, int faturaNo)
 {return Json(global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Models.PackingListViewModel>());
}



        [HttpPost("SavePackingList")]
        public async Task<IActionResult> SavePackingList([FromBody] PackingListViewModel model)
 {return Content("Ön yüz örneği: dosya üretilmez.", "text/plain; charset=utf-8");
}
