...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor41Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.TevkifatRaporuViewModel>(12));
}
        ...
        private List<TevkifatRaporuViewModel> GetTevkifatRaporuData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
