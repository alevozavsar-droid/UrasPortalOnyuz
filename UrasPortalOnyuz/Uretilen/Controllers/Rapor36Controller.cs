...
using WebApplication3.Models; // Bu Model Sınıflarınızın bulunduğu varsayılmıştır.

namespace WebApplication3.Controllers
{
    [Authorize]

    [Route("[controller]")] // Temel Rota: /Rapor36
    public class Rapor36Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor36Controller> _logger;
        ...
        private static readonly string UDT_OBJECT_TYPE = "CR_NOTLAR"; // UDT adı
 ...
 {return default;
        ...
        private async Task<List<CustomerFinancialReportViewModel>> GetFinancialReportDataAsync(string connectionString)
 {return default;
}


        private async Task<Dictionary<string, List<CustomerNoteViewModel>>> GetCustomerNotesAsync(string connectionString, List<string> cardCodes)
 {return default;
}
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.CustomerRiskReportViewModel>(12));
}
        ...
        [HttpPost]
        [Route("AddNote")]
        public async Task<IActionResult> AddNote([FromBody] NewNoteModel model)
 {return Json(new { message = "Not başarıyla eklendi.", cardCode = global::WebApplication3.OrnekDoldurucu.Deger<string>("cardCode", 0), newNoteId = global::WebApplication3.OrnekDoldurucu.Deger<int>("newNoteId", 0) });
}


        [HttpPost]
        [Route("UpdateNote")] // Route düzeltildi: "Rapor36/UpdateNote" yerine "UpdateNote" (RoutePrefix'ten dolayı)
 ...
 {return Json(new { success = true, message = "Not başarıyla güncellendi." });
        ...
        [HttpPost]
        [Route("DeleteNote")] // Route düzeltildi: "Rapor36/DeleteNote" yerine "DeleteNote" (RoutePrefix'ten dolayı)
        public async Task<IActionResult> DeleteNote([FromBody] NoteDeleteModel model)
