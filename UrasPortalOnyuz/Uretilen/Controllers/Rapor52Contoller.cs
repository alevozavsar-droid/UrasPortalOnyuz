...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor52Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor52Controller> _logger;
 ...
 {return default;
        ...
        private async Task<List<CariViewModel>> GetVendorListAsync(string selectedDbKey)
 {return default;
}



        private async Task<List<Rapor52ViewModel>> GetRaporDataAsync(string selectedDbKey, string bpCode)
 {return default;
}
        private async Task<List<VendorReconciliationSimulationViewModel>> GetReconciliationSimulationDataAsync(string selectedDbKey, string bpCode)
 {return default;
}
...
ViewBag.VendorList = WebApplication3.OrnekDoldurucu.Liste<CariViewModel>(12);
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.Rapor52ViewModel>(12));
}
...
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("ReconciliationSimulation", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.VendorReconciliationSimulationViewModel>(12));
}
