...
namespace WebApplication3.Controllers
{
    ...
    [Authorize]
    [Route("AcikTalepSiparis")]
    public class Rapor51Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor51Controller> _logger;
...
return View("Index", WebApplication3.OrnekDoldurucu.Yeni<WebApplication3.Models.Rapor51ViewModel>());
}
    }
}