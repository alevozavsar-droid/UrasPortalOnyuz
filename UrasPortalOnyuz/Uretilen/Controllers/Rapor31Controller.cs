...
namespace WebApplication3.Controllers
{
    ...
    [Authorize] // Yeni bir politika adı varsayılmıştır
    [Route("[controller]")]
    public class Rapor31Controller : Controller
    {
 ...
 {return default;
        ...
        private List<UrunViewModel> GetUrunList(string connectionString, string search)
 {return default;
}

        [HttpGet("GetUrunler")]
        public IActionResult GetUrunler(string term)
 {return Json(new { results = global::System.Linq.Enumerable.Range(0, 12).Select(i2 => new { id = global::WebApplication3.OrnekDoldurucu.Deger<string>("id", i2), text = global::WebApplication3.OrnekDoldurucu.Deger<string>("text", i2) }).ToList() });
}



        [Authorize]
        public IActionResult Index(string itemCode, DateTime? startDate, DateTime? endDate)
 {ViewBag.CurrentDbDisplay = "";
ViewBag.SelectedItemCode = "";
ViewBag.SelectedItemName = "";
ViewBag.Urunler = WebApplication3.OrnekDoldurucu.Liste<UrunViewModel>(12);
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.StokHareketViewModel>(12));
}


        private string GetItemName(string connectionString, string itemCode)
 {return default;
}


        private List<StokHareketViewModel> GetStokHareketData(string connectionString, string itemCode, DateTime? startDate, DateTime? endDate)
 {return default;
}
    }
}