...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor108Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor108Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Customers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.CustomerModel>(12);
ViewBag.Items = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.ItemModel>(12);
ViewBag.SalesEmployees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.SalesEmployeeModel>(12);
ViewBag.VatGroups = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.VatGroupModel>(12);
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.MuafCodes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.MuafCodeModel>(12);
ViewBag.Countries = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.CountryModel>(12);
ViewBag.States = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.StateModel>(12);
ViewBag.Warehouses = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.WarehouseModel>(12);
ViewBag.Drivers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor108Controller.DriverModel>(12);
...
return View("Index");
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor108Controller.DeliveryDetailViewModel>() });
}
        ...
        public IActionResult GetOpenOrders(string cardCode)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Satirlar(12, new[] { "DocEntry", "DocNum", "DocDate", "DocDueDate", "DocCur", "DocTotalFC", "DocTotal" }) });
}
        ...
        [HttpGet("GetRelationshipMap")]
        public IActionResult GetRelationshipMap(int docEntry)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Satirlar(12, new[] { "DocEntry", "DocNum", "DocType", "DocStatus", "CANCELED", "DocDate" }) });
}
 ...
 {return Json(new { currency = global::WebApplication3.OrnekDoldurucu.Deger<string>("currency", 0), slpCode = global::WebApplication3.OrnekDoldurucu.Deger<int>("slpCode", 0) });
}

        [HttpGet("GetCustomerAddresses")]
        public IActionResult GetCustomerAddresses(string cardCode)
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor108Controller.BPAddressModel>(12));
}
 ...
 {return Json(new { onHand = 0 });
        ...
        [HttpGet("GetDeliveryNavigation")]
        public IActionResult GetDeliveryNavigation(int currentDocEntry, string direction)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor108Controller.DeliveryDetailViewModel>() });
}

        [HttpPost("FindDelivery")]
        public IActionResult FindDelivery([FromBody] DeliverySearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor108Controller.DeliverySearchResultModel>(12) });
}

        [HttpGet("GetDeliveryDetails")]
        public IActionResult GetDeliveryDetails(int docEntry)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor108Controller.DeliveryDetailViewModel>() });
}
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor108Controller.DriverModel>() });
}
        ...
        public async Task<IActionResult> CreateDelivery([FromBody] DeliveryCreationModel request)
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
        ...
        public async Task<IActionResult> CreateReturn([FromBody] DeliveryCreationModel request)
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
}
        ...
        public async Task<IActionResult> CancelDelivery(int docEntry)
 {return Json(new { success = true, message = "Teslimat başarıyla iptal edildi." });
}
 ...
 {return default;
        ...
        public class DeliverySearchResultModel
        {
        ...
        public class DeliveryDetailViewModel
        {
            ...
            public List<DeliveryLineModel> Lines { get; set; } = new List<DeliveryLineModel>();
        }
        ...
        public class DeliveryCreationModel
        {
            ...
            public AddressExtensionModel AddressExtension { get; set; }
            public List<DeliveryLineModel> DocumentLines { get; set; }
        }
