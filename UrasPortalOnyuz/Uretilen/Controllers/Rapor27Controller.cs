...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor27Controller : Controller
    {
 ...
 {return default;
        ...
        private List<UrunViewModel> GetUrunList(string connectionString)
 {return default;
}

        private string GetUrunName(string connectionString, string itemCode)
 {return default;
}

        private List<UrunStokHareketiViewModel> GetUrunStokHareketiData(string connectionString, string itemCode, DateTime? startDate, DateTime? endDate)
 {return default;
}
...
ViewBag.SelectedUrunKodu = "";
ViewBag.SelectedUrunName = "";
ViewBag.UrunList = WebApplication3.OrnekDoldurucu.Liste<UrunViewModel>(12);
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.UrunStokHareketiViewModel>(12));
}
    }
}