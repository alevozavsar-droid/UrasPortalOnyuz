...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor5Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor5Controller> _logger;
        ...
        private readonly List<DatabaseConfig> _databases = new List<DatabaseConfig>
        {
            ...
            new DatabaseConfig { Key = "DefaultConnection4", Display = "DAF_KİMYA" },
            ...
            new DatabaseConfig { Key = "DefaultConnection9", Display = "AVRASYA" },
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.GroupedFinancialData>(12));
}

        [HttpGet("HesapDetayiGetir")]
        public IActionResult HesapDetayiGetir(string kaynakFirma, string karsiFirma, string tip, DateTime startDate, DateTime endDate)
 {return Json(global::WebApplication3.OrnekDoldurucu.Satirlar(12, new[] { "HesapKodu", "HesapAdi", "ParaBirimi", "BakiyeDoviz", "BakiyeTRY" }));
}
    }
}