...
{
    public class Rapor71Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor71Controller> _logger;
 ...
 {return default;
        ...
        public async Task<IActionResult> Index2(DateTime? tarih)
 {ViewBag.CurrentDbDisplay = "";
ViewBag.JsonData = "";
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index2", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.Rapor71ViewModel>(12));
}

        [HttpPost]
        [Route("Rapor71/UpdateKullanimDurumu")]
        public async Task<IActionResult> UpdateKullanimDurumu([FromBody] dynamic model)
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
}

        [HttpPost]
        [Route("Rapor71/UpdatePlannedSupplier")]
        public async Task<IActionResult> UpdatePlannedSupplier([FromBody] dynamic model)
