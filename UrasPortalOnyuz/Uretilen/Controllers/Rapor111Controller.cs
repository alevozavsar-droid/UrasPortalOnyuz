...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor111Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor111Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Customers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.CustomerModel>(12);
ViewBag.Items = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.ItemModel>(12);
ViewBag.SalesEmployees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.SalesEmployeeModel>(12);
ViewBag.VatGroups = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.VatGroupModel>(12);
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.MuafCodes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.MuafCodeModel>(12);
ViewBag.Countries = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.CountryModel>(12);
ViewBag.States = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.StateModel>(12);
ViewBag.Warehouses = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.WarehouseModel>(12);
ViewBag.Drivers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.DriverModel>(12);
ViewBag.Accounts = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.AccountModel>(12);
ViewBag.Employees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor111Controller.EmployeeModel>(12);
...
return View("Index");
        ...
        {
            { 13, ("OINV", "INV1", "Satış Faturası") }, { 16, ("ORDN", "RDN1", "İade İrsaliyesi") }
        };


        private static readonly int[] _izinliBazTipleri = new int[] { 13, 16 };
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor111Controller.CreditMemoDetailViewModel>(), baseTypeName = global::WebApplication3.OrnekDoldurucu.Deger<string>("baseTypeName", 0), baseType = global::WebApplication3.OrnekDoldurucu.Deger<int>("baseType", 0), baseEntry = global::WebApplication3.OrnekDoldurucu.Deger<int>("baseEntry", 0), ek = (object)global::WebApplication3.OrnekDoldurucu.Deger<string>("ek", 0) });
}

        [HttpGet("GetCustomerInfo")]        public IActionResult GetCustomerInfo(string cardCode)
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor111Controller.BPAddressModel>(12));
}
 ...
 {return Json(new { onHand = 0 });
        ...
        [HttpGet("GetCreditMemoNavigation")]
        public IActionResult GetCreditMemoNavigation(int currentDocEntry, string direction)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor111Controller.CreditMemoDetailViewModel>() });
}

        [HttpPost("FindCreditMemo")]
        public IActionResult FindCreditMemo([FromBody] CreditMemoSearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor111Controller.CreditMemoSearchResultModel>(12) });
}

        [HttpGet("GetCreditMemoDetails")]
        public IActionResult GetCreditMemoDetails(int docEntry)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor111Controller.CreditMemoDetailViewModel>() });
}

        [HttpPost("AddDriver")]
        public IActionResult AddDriver([FromBody] DriverModel request)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor111Controller.DriverModel>() });
}
        ...
        public async Task<IActionResult> CreateCreditMemo([FromBody] CreditMemoCreationModel request)
 {return Json(new { success = true, taslak = global::WebApplication3.OrnekDoldurucu.Deger<bool>("taslak", 0), message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
}
 ...
 {return default;
        ...
        private void GiderleriYaz(string connectionString, string tablo, int docEntry, List<CreditMemoLineModel> lines)
 {}
 ...
 {return default;
        ...
        public class CreditMemoSearchModel
        {
        ...
        public class CreditMemoSearchResultModel
        {
        ...
        public class CreditMemoDetailViewModel
        {
            public int DocEntry { get; set; }
            ...
            public List<CreditMemoLineModel> Lines { get; set; } = new List<CreditMemoLineModel>();
        }

        public class CreditMemoCreationModel
        {
            ...
            public AddressExtensionModel AddressExtension { get; set; }
            public List<CreditMemoLineModel> DocumentLines { get; set; }
        }

        public class CreditMemoLineModel
        {
