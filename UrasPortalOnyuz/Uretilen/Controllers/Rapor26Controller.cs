...
{
    [Route("[controller]")]
    public class Rapor26Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor26Controller> _logger;
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.Rapor26ViewModel>(12));
}
