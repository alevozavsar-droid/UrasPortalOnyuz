...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor128Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor128Controller> _logger;
 ...
 {return default;
        ...
        private FinekraCompanyConfig GetCompanyConfig(string dbKey)
 {return default;
}
 ...
 {return default;
        ...
        private async Task<List<BankaHareketiViewModel>> GetBankaHareketleriAsync(string token, DateTime startDate, DateTime endDate)
 {return default;
}
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor128Controller.DatabaseConfig>(12);
ViewBag.AccountsAndBPs = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor128Controller.AccountBPModel>(12);
ViewBag.CurrentDbName = "";
ViewBag.CurrentDbDisplay = "";
ViewBag.FinekraHata = "";
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor128Controller.NakitAkis128ViewModel>(12));
}
 ...
 {return default;
        ...
        public async Task<IActionResult> CreateJournalEntry([FromBody] VirmanCreationRequest request)
 {return Json(new { success = true, message = global::WebApplication3.OrnekDoldurucu.Deger<string>("message", 0) });
        ...
        public class NakitAkis128ViewModel
        {
        ...
        public class VirmanCreationRequest
        {
