...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor47Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.TaslakFaturaRaporuViewModel>(12));
}
        ...
        private List<TaslakFaturaRaporuViewModel> GetTaslakFaturaData(string connectionString)
 {return default;
}
