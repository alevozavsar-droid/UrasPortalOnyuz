...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor49Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.KonsolideAlimViewModel>(12));
}
        ...
        private List<KonsolideAlimViewModel> GetKonsolideAlimData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
