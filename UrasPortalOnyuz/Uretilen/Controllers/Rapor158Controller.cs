...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor158Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor158Controller> _logger;
 ...
 {ViewBag.Databases = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.DatabaseConfig>(12);
ViewBag.CurrentDbDisplay = "";
ViewBag.Customers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.CustomerModel>(12);
ViewBag.Items = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.ItemModel>(12);
ViewBag.SalesEmployees = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.SalesEmployeeModel>(12);
ViewBag.VatGroups = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.VatGroupModel>(12);
ViewBag.Currencies = WebApplication3.OrnekDoldurucu.Liste<string>(12);
ViewBag.MuafCodes = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.MuafCodeModel>(12);
ViewBag.Countries = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.CountryModel>(12);
ViewBag.States = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.StateModel>(12);
ViewBag.Warehouses = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.WarehouseModel>(12);
ViewBag.Drivers = WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor158Controller.DriverModel>(12);
...
return View("Index");
        ...
        private static readonly int[] _izinliBazTipleri = new int[] { 22 };
 ...
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor158Controller.PurchaseDeliveryNoteDetailViewModel>(), baseTypeName = global::WebApplication3.OrnekDoldurucu.Deger<string>("baseTypeName", 0), baseType = global::WebApplication3.OrnekDoldurucu.Deger<int>("baseType", 0), baseEntry = global::WebApplication3.OrnekDoldurucu.Deger<int>("baseEntry", 0) });
}
 ...
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor158Controller.BPAddressModel>(12));
}
 ...
 {return Json(new { onHand = 0 });
        ...
        [HttpGet("GetPurchaseDeliveryNoteNavigation")]
        public IActionResult GetPurchaseDeliveryNoteNavigation(int currentDocEntry, string direction)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor158Controller.PurchaseDeliveryNoteDetailViewModel>() });
}

        [HttpPost("FindPurchaseDeliveryNote")]
        public IActionResult FindPurchaseDeliveryNote([FromBody] PurchaseDeliveryNoteSearchModel search)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Controllers.Rapor158Controller.PurchaseDeliveryNoteSearchResultModel>(12) });
}

        [HttpGet("GetPurchaseDeliveryNoteDetails")]
        public IActionResult GetPurchaseDeliveryNoteDetails(int docEntry)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor158Controller.PurchaseDeliveryNoteDetailViewModel>() });
}

        [HttpPost("AddDriver")]
        public IActionResult AddDriver([FromBody] DriverModel request)
 {return Json(new { success = true, data = global::WebApplication3.OrnekDoldurucu.Yeni<global::WebApplication3.Controllers.Rapor158Controller.DriverModel>() });
}




        [HttpPost("CreatePurchaseDeliveryNote")]
        public async Task<IActionResult> CreatePurchaseDeliveryNote([FromBody] PurchaseDeliveryNoteCreationModel request)
 ...
 {return default;
        ...
        public class PurchaseDeliveryNoteSearchModel
        {
        ...
        public class PurchaseDeliveryNoteSearchResultModel
        {
        ...
        public class PurchaseDeliveryNoteDetailViewModel
        {
            public int DocEntry { get; set; }
            public int DocNum { get; set; }
            public string CardCode { get; set; }
            ...
            public List<PurchaseDeliveryNoteLineModel> Lines { get; set; } = new List<PurchaseDeliveryNoteLineModel>();
        }

        public class PurchaseDeliveryNoteCreationModel
        {
            public string CardCode { get; set; }
            ...
            public AddressExtensionModel AddressExtension { get; set; }
            public List<PurchaseDeliveryNoteLineModel> DocumentLines { get; set; }
        }

        public class PurchaseDeliveryNoteLineModel
        {
