...
{
    public class UretimRaporViewModel
    {
        ...
        public decimal SecondUnitMultiplier { get; set; }
        public decimal TotalSecondQuantity { get; set; }
    }

  

    [Authorize]
    public class Rapor138Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor138Controller> _logger;
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.UretimRaporViewModel>(12));
}

        [HttpGet]
        public IActionResult ExportExcel(DateTime? startDate, DateTime? endDate, string db)
 {return Content("Ön yüz örneği: dosya üretilmez.", "text/plain; charset=utf-8");
}

        private List<UretimRaporViewModel> GetProductionData(string dbKey, string dbName, DateTime startDate, DateTime endDate)
 {return default;
}
    }
}