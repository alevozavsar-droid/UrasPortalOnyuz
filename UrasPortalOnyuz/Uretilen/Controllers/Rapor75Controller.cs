...
namespace WebApplication3.Controllers
{
    ...
    [Route("[controller]")]
    public class Rapor75Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor75Controller> _logger;
 ...
 {ViewBag.ItemCodeList = new System.Collections.Generic.List<object>();
ViewBag.ItemNameList = new System.Collections.Generic.List<object>();
WebApplication3.OrnekDoldurucu.Hazirla(this);
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.StockReportViewModel>(12));
}
