...
using System.Data;
using ClosedXML.Excel; // *** YENİ: ClosedXML kütüphanesi eklendi ***
using System.IO;

namespace WebApplication3.Controllers
{
    [Authorize] // İhtiyacınıza göre policy adını değiştirin
    [Route("[controller]")]
    public class Rapor40Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Models.KDVIndirimViewModel>(12));
}
        ...
        private List<KDVIndirimViewModel> GetKDVIndirimData(string connectionString, DateTime startDate, DateTime endDate)
 {return default;
}
