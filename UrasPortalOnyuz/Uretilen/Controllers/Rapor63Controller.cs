...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor63Controller : Controller
    {
...
return View("Index", WebApplication3.OrnekDoldurucu.Liste<WebApplication3.Controllers.Rapor63ViewModel>(12));
}

        private List<Rapor63ViewModel> GetRaporData(string connectionString, DateTime startDate, DateTime endDate, List<string> selectedItems)
 {return default;
}
 ...
 {return Content("Ön yüz örneği: dosya üretilmez.", "text/plain; charset=utf-8");
    ...
    public class Rapor63ViewModel
    {
        ...
        public string AnlasilanDoviz { get; set; } // YENİ ALAN (ViewModel)
        ...
        public string CariTipiAciklamasi { get; set; }
