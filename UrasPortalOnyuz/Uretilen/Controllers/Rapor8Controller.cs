...
using WebApplication3.Models; // Modellerinizin burada olduğunu varsayıyoruz
using System;
using System.Linq;
...
namespace WebApplication3.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class Rapor8Controller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<Rapor8Controller> _logger;
        ...
        private List<SalesPerson> _salesPersons = new List<SalesPerson>();
...
return View("Index");
        ...
        private List<SalesPerson> GetSalesPersons(string connectionString)
 {return default;
}

        [HttpPost("UpdateSalesPerson")]
        public async Task<IActionResult> UpdateSalesPerson([FromBody] UpdateSalesPersonModel model)
 {return Json(new { success = true, message = "Satış temsilcisi başarıyla güncellendi." });
}


        [HttpGet("GetProductCostDetails")]
        public async Task<IActionResult> GetProductCostDetails(string itemCode)
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Models.ProductCostDetailViewModel>(12));
}

        [HttpGet("GetInvoiceDetails")]
        public async Task<IActionResult> GetInvoiceDetails(int docEntry)
 {return Json(global::WebApplication3.OrnekDoldurucu.Liste<global::WebApplication3.Models.InvoiceDetailViewModel>(12));
}
    }
}